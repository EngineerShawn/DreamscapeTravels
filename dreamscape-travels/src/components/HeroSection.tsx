    ...
    return (
        <header className="relative h-[60vh] md:h-[70vh] flex items-center justify-center text-white text-center px-4">
            ...
            <div className="relative z-20 max-w-3xl">
                <h1 className="text-4xl md:text-6xl font-extrabold font-serif leading-tight tracking-tight shadow-lg">Your Personal Escape Planner</h1>
                ...
                <Button onClick={onOpenModal} color="primary" size="lg" className="mt-8 font-bold text-lg">
